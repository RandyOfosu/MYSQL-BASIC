...
localhost/mod_mysql_basic_imdb_movies/movies/		http://localhost:8888/phpMyAdmin/tbl_sql.php?db=mod_mysql_basic_imdb_movies&table=movies
 Showing rows 0 - 29 (98 total, Query took 0.0007 seconds.)
